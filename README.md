# Плагин IntelliJ IDEA для генерации текстового описания к архитектурной схеме с помощью AI

## О плагине
<!-- Plugin description -->

Плагин позволяет создавать и редактировать диаграммы в формате drawio и автоматически с помощью AI формировать документ с текстовым описанием к диаграмме. 
